    ...
    <div class="min-h-screen bg-dark">
      ...
      <div class="max-w-screen-6xl mx-auto px-4 py-8 text-xl">
        <div class="font-inter text-white font-extrabold text-center lg:(text-2xl)">
           <h1> Terms of Service for Munio bot</h1>
        </div>
        ...
        <div class="pl-3 pr-2 pt-4 lg:(pt-2)">
          <ul class="list-disc font-open-sans text-light space-y-2 text-base lg:(text-lg)">
            {[
              "By using Munio bot, you agree to Terms of Service to not use this bot to promote any illegal activity or use bot in any abusive manner that violate discord rules or disrupt Discord API in any manner. Users must be 13+ older in order to use our bot service. ",
